...
test('should import standalone mock system', () => {
  const { standaloneMockSystem } = require('../main/helpers/developmentMockSystem.standalone');
...
test('should import mock system utils', () => {
  const { mockSystemUtils } = require('../main/helpers/developmentMockSystem.standalone');
